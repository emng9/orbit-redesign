...
export default function LoginPage() {
  ...
  return (
    <div
      className="relative flex min-h-dvh flex-col items-center overflow-hidden bg-background px-4 py-16"
      style={{ fontFamily: "var(--font-geist-sans), ui-sans-serif, system-ui, sans-serif" }}
    >
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_50%_32%,rgba(180,56,10,0.08),transparent_60%)]"
      />
      ...
      <div className="relative z-10 flex flex-col items-center gap-4">
        <div aria-hidden="true" className="pointer-events-none absolute top-1/2 left-1/2 size-0">
          {RING_SIZES.map((size) => (
            <div
              key={size}
              className="absolute top-0 left-0 -translate-x-1/2 -translate-y-1/2 rounded-full border border-[#B4380A]/[0.08]"
